 ...
 * Be aware that this orientation mask will be taken into consideration only if this view controller
 * is the root view controller or the topmost presented view controller. For example, this
 * orientation mask will not be taken into consideration if the view controller is the root view
 * controller of a UINavigationController (in that case the UINavigationController's
...
/**
 * \brief Register a warnings observer for this barcode picker.
 *
 * \param observer The observer to register. If the observer is nil, this method has no effect.
 *
 * \since 5.11.1
 */
...
/**
 * \brief Unregister a warnings observer for this barcode picker.
 *
 * \param observer The observer to unregister. If the observer is nil, this method has no effect.
 *
 * \since 5.11.1
 */
